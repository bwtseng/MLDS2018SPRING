...
for i in range(100):
	...
	fc3 , output,para= main(w_variable,b_variable)
	tt.append(para)
	if i == 0 :
		para_trace.append(para)
	else : 
		para_trace.append(para-tt[i-1])
...
plt.scatter(para_trace,loss_train_record)
plt.scatter(para_trace,loss_test_record)
...
plt.scatter(para_trace,acc_train_record)
plt.scatter(para_trace,acc_test_record)
plt.xlabel('parameters')
plt.ylabel('accuracy')
plt.legend(['train','test'],loc='upper right')
plt.show()